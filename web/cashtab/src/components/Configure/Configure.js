                ...
                </div>
                {
                    authentication ? 
                        <Switch 
                            ...
                            checked={(authentication.isAuthenticationRequired && authentication.credentialId) ? true : false}
                            // checked={false}
                            onChange={handleAppLockToggle}
                        />
                        :
                        <Tag color='warning' icon={<ExclamationCircleFilled />}>Not Supported</Tag>
                }
            </GeneralSettingsItem>
            <StyledSpacer />[
            <SettingsLink
